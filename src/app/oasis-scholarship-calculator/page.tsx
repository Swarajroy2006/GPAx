...
export default function OasisCalculatorPage() {
  ...
  const [category, setCategory] = useState<'SC' | 'ST' | 'OBC'>('SC');
  ...
  const breadcrumbs = [
    ...
    { label: 'Oasis Scholarship Calculator' }
  ];
      ...
      <main className="flex-grow bg-gray-50/50 dark:bg-gray-950/20 py-8 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <span className="px-3 py-1.5 rounded-full bg-brand-accent/10 text-brand-accent text-xs font-semibold uppercase tracking-wider">Oasis Special</span>
            <h1 className="text-3xl md:text-5xl font-extrabold text-gray-950 dark:text-white mt-3">Oasis Scholarship Calculator</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 max-w-xl mx-auto">
              Check eligibility for West Bengal Oasis SC, ST, and OBC student scholarship programs.
            </p>
          </div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle>Oasis Credentials</CardTitle>
                  </div>
                  <CardDescription>Input your academic and category details.</CardDescription>
                </CardHeader>
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-2 max-w-xs mx-auto leading-relaxed">
                          Student satisfies the requirements for {category} category under the Oasis portal.
                        </p>
                      </div>
                    </div>
                  ) : (
